...
if (!$this->getAttributeId(Mage_Catalog_Model_Category::ENTITY, 'nav_featured_image')) {
...
if (!$this->getAttributeId(Mage_Catalog_Model_Category::ENTITY, 'nav_featured_link')) {
...
if (!$this->getAttributeId(Mage_Catalog_Model_Category::ENTITY, 'nav_featured_text')) {
